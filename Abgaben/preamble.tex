...
sensitive=true,
morekeywords={TABLE, ON, UPDATE, DELETE, CREATE, OPERATOR, FUNCTION, SELECT,DISTINCT, FROM, WHERE, FILTER, ORDER, GROUP, BY, HAVING, IN, AS, GRAPH, SERVICE, PREFIX, ASC, DESC, LIMIT, SUM, MIN, MAX}
}
